...
<head>
  ...
  <title>Ban Reviews - Moderator Dashboard</title>
...
require_once __DIR__ . '/../config/supabase-session.php'; echo htmlspecialchars($username); ?></strong>
    ...
    <div class="page-header">
      <h1>
        <i class="bi bi-flag-fill"></i> Ban Review Queue
      </h1>
      <p>View users flagged for potential bans - All ban decisions are handled by administrators</p>
...
require_once __DIR__ . '/../config/supabase-session.php'; endif; ?>
          ...
          <div class="review-actions">
            <div class="alert" style="background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.3); border-radius: 0.75rem; padding: 1rem; margin: 0; color: rgba(255, 255, 255, 0.9);">
              <i class="bi bi-info-circle-fill" style="color: #fca5a5;"></i>
              <strong>Pending Admin Review:</strong> This ban request has been forwarded to administrators for final approval.
            </div>
          </div>
        </div>
      <?php
