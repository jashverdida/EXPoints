...
<body>
    ...
    <main class="container-xl py-4">
        ...
        <div class="stats-bar">
            <div class="stat-item">
                <span class="stat-value" id="totalGames">{{ $totalGames }}</span>
                <div class="stat-label">Games Available</div>
            </div>
            <div class="stat-item">
                <span class="stat-value" id="totalReviews">{{ $totalReviews }}</span>
        ...
        <div id="gamesContainer">
            ...
            @else
                @foreach($games as $index => $game)
                    @php
                        $isPopular = $index < 3 && $game['review_count'] >= 5;
                    @endphp
                    <a href="{{ route('dashboard') }}?search={{ urlencode($game['name']) }}&filter=game"
                       class="game-card"
                       data-game-name="{{ strtolower($game['name']) }}">
                        ...
                        <div class="game-card-stats">
                            <span>
                                ...
                                <strong>{{ $game['review_count'] }}</strong> {{ $game['review_count'] == 1 ? 'review' : 'reviews' }}
                            </span>
                        </div>
                    </a>
                @endforeach
    ...
    <aside class="side">
        ...
        <div class="side-inner">
            <div class="side-box">
                ...
                <button class="side-btn active" title="Games"><i class="bi bi-grid-3x3-gap"></i></button>
