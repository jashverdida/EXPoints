  ...
  <div class="split-screen-container">
    ...
    <div class="left-side">
      <div class="register-form-container">
        ...
        <a href="{{ route('home') }}" class="back-button-register">
...
<script>
  ...
  document.getElementById('completeRegistration').addEventListener('click', async function() {
    ...
    // Prepare registration data for Laravel
    ...
    formData.append('suffix', tempFormData.suffix);
    formData.append('email', tempFormData.email);
    formData.append('password', tempFormData.password);
    formData.append('password_confirmation', tempFormData.password);
  ...
  document.getElementById('usernameModal').addEventListener('click', function(e) {
    if (e.target === this) {
